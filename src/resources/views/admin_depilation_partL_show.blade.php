...
<div class="sub_body">
    ...
    <div class="card">
        ...
        <form action="{{ route('admin_depilation_partL.update', $L['id']) }}" class="admin_update_form" method="POST">
            @csrf
            ...
            <div class="admin_update_delete">
                <a href="/admin/depilation/partL/delete/{{ $L['id'] }}" class="admin_delete_button">削除</a>
